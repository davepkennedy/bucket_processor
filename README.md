...
This is a sample template for bucket-processor - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name bucket-processor --query 'Stacks[].Outputs'
```
